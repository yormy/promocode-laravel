...
export default defineConfig({
  title: "Promocode",
  description: "Dealing with promocodes",
  base: '/promocode-laravel/',
  head: [
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Home', link: '/' },
      { text: 'Guide', link: '/v1/introduction/what-is-promocode' },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/yormy/promocode-laravel' }
    ]
  }
})
